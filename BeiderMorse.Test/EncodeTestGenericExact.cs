...
{
   public class EncodeTestGeneircExact
   {
      [Fact]
      ...
      public void Encoder_D_Apostrophe_Name_Concat(string name, string expectedPhoneticCode)
      {
      ...
      public void Encoder_Input_Prefix_Multi_Word(string input, string encoded)
      {
         IPhoneticEngine encoder = new GenericExactPhoneticEngine(true);
